...
I am a bioinformatician with a Bachelor's in Molecular Biology & Biotechnology and a Master's in Bioinformatics. In my projects, I emphasize reproducibility and scalability. To that end, I am a broadly setup with different programming languages for computational/scientific tasks: **Python • C  • Java • R • Bash • LaTeX**.  
...
- [*Gzip Compression Rate as Proxy for Structural Redundancy in Transcriptomes*](https://github.com/Wildapfel/compression-transcriptomes) - A pipeline to detect structural repeats across evolution of eukaryotic transcriptomes.
</details>
